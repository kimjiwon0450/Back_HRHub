...
//
//    // 전체부서 공지사항 조회
//    public List<Notice> getFilteredGeneralNoticesByPosition(Position position, String keyword, LocalDate fromDate, LocalDate toDate,
...
//        }
//
//        return noticeRepository.findGeneralNoticesByPosition(position, keyword, fromDateTime, toDateTime, pageable);
//    }
//
//
//    // ✅ 상단 공지글 5개 조회 (정렬 기준 반영)
//    public Page<Notice> getDepNotices(String sortBy, String sortDir) {
//        log.info("case1");
//        Sort.Direction direction = sortDir.equalsIgnoreCase("asc") ? Sort.Direction.ASC : Sort.Direction.DESC;
//        Pageable pageable = PageRequest.of(0, 5, Sort.by(Sort.Direction.DESC, "createdAt"));
//        Page<Notice> topNotices = noticeRepository.findTopNotices(pageable);
...
//
//    // ✅ 필터링된 공지글 조회 (최대 100개)
//    public Page<Notice> getFilteredNotices(String keyword, LocalDate from, LocalDate to, int pageSize, String sortBy, String sortDir) {
//        log.info("case4");
//
...
//
//    // ✅ 필터링된 공지글 조회 (최대 100개)
//    public Page<Notice> getFilteredNoticesByPosition(String keyword, LocalDate from, LocalDate to, int pageSize, String sortBy, String sortDir) {
//        log.info("case4");
//
//        // LocalDate → LocalDateTime으로 변환 (자정 기준)
//        LocalDateTime fromDateTime;
...
//
//    // 내가 쓴 글 조회(공지글)
//    public List<Notice> getMyNotice(Long employeeId) {
//        return noticeRepository.findByEmployeeIdAndBoardStatusTrueAndNoticeTrueOrderByCreatedAtDesc(employeeId);
//    }
//
//    // 내가 쓴 글 조회(일반글)
