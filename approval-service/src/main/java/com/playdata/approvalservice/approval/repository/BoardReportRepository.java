...
import com.playdata.approvalservice.approval.entity.BoardReport;
...
public interface BoardReportRepository extends JpaRepository<BoardReport, Long> {
     ...
     * @return 보고서 리스트
     */
    List<BoardReport> findBySubmitId(Long submitId);
     ...
     * @return 보고서 리스트
     */
    List<BoardReport> findByStatus(ReportType status);
